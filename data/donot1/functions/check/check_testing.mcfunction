...
execute as @e[type=minecraft:armor_stand,tag=WalkedOn] at @s align xz unless entity @e[type=minecraft:player,dx=0,dy=1,dz=0] run summon minecraft:tnt ~ ~1 ~ {Fuse:50}
